...
INSTANCE_ID=$(aws ec2 run-instances --image-id ami-30ef0556 --count 1 --instance-type t2.micro --key-name birdmen --security-group-ids sg-20a1f244 --subnet-id subnet-998a7cee --profile birdmen |jq -r .Instances[].InstanceId
)
