...
INSTANCE_ID=$(aws ec2 run-instances --image-id ami-068a6cefc24c301d2 --count 1 --instance-type t3.nano --key-name birdmen --security-group-ids sg-20a1f244 --subnet-id subnet-998a7cee --profile birdmen |jq -r .Instances[].InstanceId
)
